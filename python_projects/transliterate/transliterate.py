...
def normalize_apostrophes(text):
  """
  Turli xil apostroflarni bitta standart ko'rinishga keltiradi.
  """
...
def to_cyrillic(text):
    ...
    # Fix Uzbek apostrophe letters
    text = text.replace("г'", "ғ")
    text = text.replace("Г'", "Ғ")
    
    text = text.replace("о'", "ў")
    text = text.replace("О'", "Ў")
    
    text = text.replace("гʼ", "ғ")
    text = text.replace("Гʼ", "Ғ")
    
    text = text.replace("оʼ", "ў")
    text = text.replace("Оʼ", "Ў")
...
def transliterate(text: str, to_variant: str) -> str:
    ...
    raise ValueError(
        f"Unknown transliteration variant: {to_variant}"
    )
